...
public class MainActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (checkConnectivity()) {
			browser.loadUrl("http://pykod.com/aawaz/index.php?r=user/auth/login");
		}
	...
	void shareURL() {
		...
		// This will put the share text: "I came across "BrowserTitle" using "appname"
		shareIntent.putExtra(Intent.EXTRA_TEXT,
				(getText(R.string.share1) + " " + browser.getTitle() + " "
						+ getText(R.string.share2) + " " + appname + " https://play.google.com/store/apps/details?id=" + getApplicationContext().getPackageName()));
